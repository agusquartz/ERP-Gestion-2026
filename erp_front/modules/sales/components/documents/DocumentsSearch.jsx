            ...
            {showStatusDrop && (
              <div className="absolute z-20 mt-2 w-full rounded-[10px] border border-slate-200 bg-white p-1.5 shadow-xl ring-1 ring-black/5">
                <button
                  ...
                  onClick={() => { setStatusFilter(""); setShowStatusDrop(false); onStatusFilter?.(""); }}
                >
                  Todas
                </button>
                ...
                {statusOptions.map((c) => (
                  <button
                    ...
                    onClick={() => { setStatusFilter(c); setShowStatusDrop(false); onStatusFilter?.(c); }}
                  >
                    {c}
                  </button>
                ))}
                    ...
                    <div className="px-3 py-2">
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          onDateFilter?.({ type: "custom", date: value });
                        }}
                      />
                    </div>
                  ) : (
